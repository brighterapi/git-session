...
description: Learn about Github and collaboration
---
...
<Steps>
  ...
  <Step title="Add key to your ssh-agent">
...
```bash
git remote add origin https://github.com/hiteshchoudhary/example-something.git
```
...
<img src="/git/images-git/git-workflow.png" alt="Git Workflow" />
